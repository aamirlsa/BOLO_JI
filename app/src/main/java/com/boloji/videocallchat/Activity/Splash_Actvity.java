...
public class Splash_Actvity extends AppCompatActivity {
    ...
    public void InterstitialLoad() {
        ...
        InterstitialAd.load(getApplicationContext(), getString(R.string.AdMob_Interstitial), adRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                Splash_Actvity.this.mMobInterstitialAds = interstitialAd;
    ...
    private void ShowFunUAds() {
        if (this.mMobInterstitialAds != null) {
            this.mMobInterstitialAds.show(Splash_Actvity.this);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                {
                    startActivity(new Intent(Splash_Actvity.this, Start_Activity.class));
                    ShowFunUAds();
                    finish();
                }
                else {
                    Toast.makeText(Splash_Actvity.this, "Please Check your connectivity", Toast.LENGTH_SHORT).show();
                }
