...
public class CuatomLayout extends ViewGroup {
    private int xPercent = 0;
    private int yPercent = 0;
    private int widthPercent = 100;
    private int heightPercent = 100;

    public CuatomLayout(Context context) {
        super(context);
    }

    public CuatomLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CuatomLayout(Context context, AttributeSet attrs, int defStyleAttr) {
